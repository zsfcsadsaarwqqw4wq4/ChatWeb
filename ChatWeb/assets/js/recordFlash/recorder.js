var Recorder = {
    ...
    audioData: function (newData) {
        ...
        //var buffer = this._mergeBuffers(data, data.length);
        var interleaved = this._interleaveSimple(data);
    ...
    _interleaveSimple: function interleaveSimple(inputL) {
        var compression = 4;
    ...
    _encodeWAV: function (samples) {
        ...
        var offset = 0;
        this._writeString(view, offset, 'RIFF'); offset += 4;
        view.setUint32(offset, 36 + dataLength, true); offset += 4;
        this._writeString(view, offset, 'WAVE'); offset += 4;
        this._writeString(view, offset, 'fmt '); offset += 4;
        ...
        this._writeString(view, offset, 'data'); offset += 4;
        view.setUint32(offset, dataLength, true); offset += 4;

        this._floatTo8BitPCM(view, 44, samples);

        return view;
    },

    _floatTo8BitPCM: function (output, offset, input) {
